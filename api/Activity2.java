...
public class Activity2 {
   ...
   @Test(priority = 1)
    ...
    public void getUserRequest(){
        ...
        System.out.println(response.body().asPrettyString());
        response.then().body("id",equalTo(Integer.parseInt(userIds)),"username",equalTo(username), "firstName", equalTo("Justin"),"lastName", equalTo("Case"),"email", equalTo("justincase@mail.com"),"phone", equalTo("9812763450"));
   }
